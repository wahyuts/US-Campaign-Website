...
const SliderEnvirontment = () => {
  ...
  const getDataChallanges = async () => {
    const API = 'https://api-prod.campaign.com/api/v1/campaign/featured-more-challenge?skip=0&take=10&orderBy=1&categoryName=Lingkungan'
    
    // API Dev dibawah
    // const API = 'https://api.campaign.com/api/v1/campaign/featured-more-challenge?skip=0&take=100&orderBy=1&categoryName=Lingkungan';
    try {
  ...
  //console.log("challDataENV",challData);
    ...
    <div className={styles.embla}> {/*embla ini container paling luar or cont card list/slider nya*/}
      <div className={styles.embla__viewport} ref={viewportRef}>
          ...
          <div className={styles.embla__container}> 
            <CardChallange challData={challData}/>
          </div>
      </div>
...
export default SliderEnvirontment;
