...
const SliderEquality = () => {
  ...
  const getDataChallanges = async () => {
    const API = 'https://api-prod.campaign.com/api/v1/campaign/featured-more-challenge?skip=0&take=10&orderBy=1&categoryName=Kesetaraan'
